...
//let dataJSON= [];
    ...
    async function processGraphs(){
        try{
            ...
            //let month_dist= new Set(res.map(obj=> obj.month).filter(m=> m!==null));
            //month_dist.forEach(m=> dataCategories.push(m));
            ...
            console.log(aids);
            //console.log(getAmt(10, "Alicante"));
            // @ts-ignore
            ...
            yAxis: {
                min: 0,
                title: {
                    text: 'Cantidad total de subvencion otorgada',
                    align: 'high'
                },
                labels: {
                    overflow: 'justify'
...
<figure class="highcharts-figure">
    ...
    <p class="highcharts-description">
        En este gráfico, se muestran la evolución del total subvencionado durante el último trimestre del 2024, mes a mes,
        a cada provincia afectada por el catástrofe de la Dana
    </p>
</figure>
